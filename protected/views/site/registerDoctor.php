...
/* @var $model RegisterDoctorForm */
/* @var $form CActiveForm */
?>

<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold mb-6">Register sebagai Dokter</h1>
    <div class="bg-white shadow rounded-lg p-6 ring-1 ring-sky-700">
        ...
        <p class="text-gray-600 mb-4">Silakan isi form untuk registrasi sebagai Dokter.</p>
        ...
        <!-- Field Specialty untuk Dokter -->
        <div class="mb-4">
            <?php echo $form->labelEx($model, 'specialty', array('class' => 'block text-gray-700 font-bold mb-2')); ?>
            <?php echo $form->textField($model, 'specialty', array(
                'class' => 'shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:shadow-outline',
                'maxlength' => 100
            )); ?>
            <?php echo $form->error($model, 'specialty', array('class' => 'text-red-500 text-sm')); ?>
        </div>
