...
<div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <a href="<?php echo Yii::app()->createUrl('admin/masterUserManagement'); ?>" class="block p-6 bg-white rounded-lg ring-1 ring-sky-700 shadow hover:bg-gray-100 transition flex gap-4 flex-col">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-10 text-sky-950">
