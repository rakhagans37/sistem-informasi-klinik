...
<div class="mb-10 flex flex-row justify-between items-center">
    <h1 class="text-3xl font-bold mb-6">Daftar Master Obat</h1>

    <div class="mb-4">
        <?php echo CHtml::link('Buat Master Obat Baru', array('admin/masterObatCreate'), array(
    ...
    <table class="w-full text-sm text-left text-gray-500">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-sky-700">
            <tr>
                ...
                <th scope="col" class="px-6 py-3">Expired Date</th>
                ...
                <?php foreach ($data as $obat): ?>
                    <tr class="bg-white border-b">
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                            <?php echo CHtml::encode($obat->nama_obat); ?>
                        </th>
                        <td class="px-6 py-4">
                            <?php echo CHtml::encode($obat->deskripsi); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo CHtml::encode($obat->jenis); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo "Rp. " .  number_format($obat->harga, 2, ',', '.'); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo CHtml::encode($obat->satuan); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo CHtml::encode($obat->expired_date); ?>
                        </td>
                        <td class="px-6 py-4 text-right flex flex-row justify-end items-center gap-4">
                            ...
                            <?php echo CHtml::link(
                                ...
                                array('admin/masterObatView', 'id' => $obat->id),
                            ...
                            <?php echo CHtml::link(
                                ...
                                ',
                                array('admin/masterObatUpdate', 'id' => $obat->id),
                            ...
                            <?php echo CHtml::link(
                                ...
                                ',
                                array('admin/masterObatDelete', 'id' => $obat->id),
                                array(
                                    'submit' => array('masterObatDelete', 'id' => $obat->id),
